      ...
      <div className="relative grid min-h-[92svh] lg:grid-cols-2">
        ...
        <div className="relative order-1 min-h-[52svh] lg:order-2 lg:min-h-full">
          ...
          <button
            ...
            onClick={() => go(index - 1)}
            aria-label="Previous fragrance"
            className="absolute left-4 top-1/2 z-10 grid h-11 w-11 -translate-y-1/2 place-items-center border border-on-ink/30 bg-ink/40 text-on-ink backdrop-blur-sm transition-colors hover:bg-on-ink hover:text-ink sm:left-6"
          >
            <ArrowLeft className="h-4 w-4" />
          </button>
          <button
            ...
            onClick={() => go(index + 1)}
            aria-label="Next fragrance"
            className="absolute right-4 top-1/2 z-10 grid h-11 w-11 -translate-y-1/2 place-items-center border border-on-ink/30 bg-ink/40 text-on-ink backdrop-blur-sm transition-colors hover:bg-on-ink hover:text-ink sm:right-6"
          >
            <ArrowRight className="h-4 w-4" />
          </button>
        </div>
